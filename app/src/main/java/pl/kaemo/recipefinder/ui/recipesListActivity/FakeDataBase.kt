...
object FakeDataBase {
    ...
    var imageUlr: List<String> = listOf(
    ...
    var recipeSummary: List<String> = listOf(
        "Slow Cooker Apple Pork Tenderloin is a gluten free and primal main course. For $4.19 per serving, this recipe covers 27% of your daily requirements of vitamins and minerals. One serving contains 486 calories, 34g of protein, and 12g of fat. Only a few people made this recipe, and 1 would say it hit the spot. (...)",
